...
const serverRoutes = require('./backend/routes/servers');
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      // Added 'unsafe-inline' here for script tags
      scriptSrc: ["'self'", "'unsafe-inline'", "fonts.googleapis.com"],
      // Added this line specifically to allow 'onclick' and other attributes
